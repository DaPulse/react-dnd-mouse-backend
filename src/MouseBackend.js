...
export default class MouseBackend {
  constructor(manager, options = {}) {
    ...
    if (options.hasExceededDistanceThreshold) {
      this.hasExceededDistanceThreshold = options.hasExceededDistanceThreshold;
    }
  }
  ...
  hasExceededDistanceThreshold(currentX, currentY, originalX, originalY) {
  ...
  handleWindowMoveCapture(e) {
    const { moveStartSourceIds, hasExceededDistanceThreshold } = this;
    const clientOffset = getEventClientOffset(e);
    ...
    if (
      ...
      moveStartSourceIds &&
      hasExceededDistanceThreshold(clientOffset.x, clientOffset.y, this.mouseClientOffset.x, this.mouseClientOffset.y)
    ) {
